#!/usr/bin/env python3
#
# Origin: https://github.com/MestreLion/git-tools/blob/master/git-restore-mtime
# after: https://github.com/MestreLion/git-tools/commit/f3cc70b73200154d027554714c354f35a08680ed
#
