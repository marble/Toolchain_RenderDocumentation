...
if fpath_buildsettings_sh:
    result["MILESTONES"].append({"fpath_buildsettings_sh": "fpath_buildsettings_sh"})

if fpath_overrides_cfg:
    result["MILESTONES"].append({"fpath_overrides_cfg": "fpath_overrides_cfg"})

if settings_json_file_2:
    result["MILESTONES"].append({"settings_json_file_2": "settings_json_file_2"})
