...
if exitcode == CONTINUE:
    masterdoc_manual_html_gifs_fixed = os.path.join(TheProjectBuildOpenOffice2Rest, 'manual-001-gifs-fixed.html')
...
if masterdoc_manual_html_gifs_fixed:
    result['MILESTONES'].append({'masterdoc_manual_html_gifs_fixed': masterdoc_manual_html_gifs_fixed})
