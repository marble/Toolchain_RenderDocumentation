...
if exitcode == CONTINUE:
    TheProjectResultBuildinfoMessageFstem = os.path.split(TheProjectResultBuildinfoMessage)[1]
...
if TheProjectLogHtmlmailMessageMdTxt: result['MILESTONES'].append(
    {'TheProjectLogHtmlmailMessageMdTxt': TheProjectLogHtmlmailMessageMdTxt})

if TheProjectLogHtmlmailMessageRstTxt: result['MILESTONES'].append(
    {'TheProjectLogHtmlmailMessageRstTxt': TheProjectLogHtmlmailMessageRstTxt})

if TheProjectLogHtmlmailMessageTxt: result['MILESTONES'].append(
